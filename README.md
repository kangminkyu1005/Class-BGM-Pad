...
> **📖 자세한 문제 해결 가이드**: 실제로 발생했던 문제들(환경변수, Firestore DB 미생성, CORS, Blaze 요금제, 캐시 등)을 증상별로 정리한 [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md)를 먼저 확인하세요. 개발 지식이 없어도 따라할 수 있게 작성되어 있습니다.
